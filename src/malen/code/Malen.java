...
public class	Malen
	...
	private Grafle[]	aGrafle;
		{
		setGrafle (new Grafle[]
			{
			new Strich (0,0,0,0,null)
	...
	private final void	setZeichnung
		(
		int	i,
		Zeichnung	aZeichnung
		)
		{
		Zeichnung[]	x = getZeichnung ();
		x[i] = aZeichnung;
	...
	public void	mouseDragged (MouseEvent e)
		...
		Grafle	g = getAktuellesGrafle ().newGrafle (
			getAltesX (), getAltesY (), 
	...
	private void	setAktuelleZeichnung (Zeichnung aZeichnung)
		...
		getNameZeichnung ().setText (
			getAktuelleZeichnung ().getName ());
		}
		...
		fw.addItemListener (
			new ItemListener ()
				...
				public void	itemStateChanged (ItemEvent e)
					{
					if (e.getItem () == SCHWARZ) setAktuelleFarbe (Color.black);
					else if (e.getItem () == ROT) setAktuelleFarbe (Color.red);
					else if (e.getItem () == GELB) setAktuelleFarbe (Color.yellow);
					else if (e.getItem () == GRUEN) setAktuelleFarbe (Color.green);
					else if (e.getItem () == BLAU) setAktuelleFarbe (Color.blue);
					else if (e.getItem () == ZYAN) setAktuelleFarbe (Color.cyan);
					else if (e.getItem () == MAGENTA) setAktuelleFarbe (Color.magenta);
	...
	private void	machNameZeichnung ()
		...
		tf.addActionListener (
			new ActionListener ()
				...
				public void	actionPerformed (ActionEvent e)
					{
					getAktuelleZeichnung ().setName (
						getNameZeichnung ().getText ());
					}
				});
		}
		...
		cb.addActionListener (
			new ActionListener ()
				...
				public void	actionPerformed (ActionEvent e)
					...
					zw.addItem (RETRIEVE);
					for (Zeichnung z2 : zz) zw.addItem (z2);
					getBehaelter ().repaint ();
					}
				});
		}
		...
		dz.addActionListener (
			new ActionListener ()
				...
				public void	actionPerformed (ActionEvent e)
					...
					JComboBox	zw = getZeichnungWahl ();
					zw.addItem (RETRIEVE);
					for (Zeichnung z : zz) zw.addItem (z);
					setAktuelleZeichnung (new Zeichnung ());
					getBehaelter ().repaint ();
					}
				});
