...
public abstract class	Konto
	...
	protected static long	euroToLong (String betrag)
		...
		try
			...
			if (p < 0 && n > 0) 
				...
				if (nach.length () == 1) nach = nach + "0";
				if (nach.length () > 2) throw new EuroFormatFehler (betrag);
	...
	public void	setEuro (String betrag)
		throws	EuroFormatFehler
		{
	...
	public 	Konto (String inhaber)
		...
		try
			...
			catch (EuroFormatFehler e) { e.printStackTrace (); }
		}
	...
	public abstract void	auszahlen (String betrag)
		throws	KontoFehler, EuroFormatFehler;
