...
public class	SparKonto
	...
	public long	getKontostand ()
		...
		setZeit (System.currentTimeMillis ());
		super.setKontostand
			((long) (super.getKontostand ()
				+ super.getKontostand ()
					* getZinssatz () / 100.0 * (getZeit () - altZeit) / 6000));
		return super.getKontostand ();
		}

	public void	auszahlen (String betrag)
		...
		if (aktuell - b < 0.0)
			...
			throw new KontoFehler (
				"Abheben vom SparKonto: "
				+ "Betrag " + betrag + " größer als " + longToEuro (aktuell));
			}
		else
			{
